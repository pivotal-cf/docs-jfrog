...
The JFrog Artifactory product includes a fully featured Docker Registry, supporting both v1 and v2 APIs, wit built in security and also the ability to proxy to remote images.
...
1. https://artifatory-docker-dev.system-domain.my-pcf.com
